...
return [
    ...
    'notifications' => [
        ...
        'name_hint' => 'Leave empty to use the default sender name.',
    ...
    'placeholders_explanation' => 'Use these placeholders in the subject and content to insert submitted values.',
    'placeholders_copy_hint' => 'Click a placeholder to copy it.',
    ...
    'no_notification_logs' => 'No notifications were sent',
    'sender' => 'Sender',
    'default_sender' => 'Default (mail config)',
    'recipient' => 'Recipient',
    'sent_at' => 'Sent at',
    'failed_at' => 'Failed at',
    'error' => 'Error',
